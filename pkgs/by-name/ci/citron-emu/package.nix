...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchgit {
    ...
    rev = "66b6d5b2da4b65d11fe54c29c3babb8fcd98bfde";
    hash = "sha256-F5oZX3LovyzBm7dD/wwR8cfHJf7sH/ddlnksuFk2ZlE=";
  ...
  cmakeFlags = [
    ...
    (lib.cmakeBool "CITRON_USE_EXTERNAL_VULKAN_HEADERS" true)
    "-DVulkan_INCLUDE_DIRS=${vulkan-headers}/include"

    # # don't use system ffmpeg, suyu uses internal APIs
    # (lib.cmakeBool "CITRON_USE_BUNDLED_FFMPEG" true)
  ...
  env = {
    NIX_CFLAGS_COMPILE = toString ([
      ...
      "-DVK_VERSION_1_3"
      "-DVK_NO_PROTOTYPES"
    ] ++ lib.optional stdenv.hostPlatform.isx86_64 "-msse4.1");
  ...
  preConfigure = lib.concatStringsSep "\n" [
    ''
      cmakeFlagsArray+=(
        "-DVULKAN_VERSION_MAX=1.3.0"
        "-DVK_VERSION_MAX=1.3.0"
